...
public class OrganizerProfileView {
    ...
    public OrganizerProfileView(User currentUser, UserService userService, OrganizerDashboard organizerDashboard) {
        this.currentUser = currentUser;
        this.userService = userService;
        this.organizerDashboard = organizerDashboard;
    }

    public VBox createOrganizerProfileView() {
        ...
        backBtn.setStyle("-fx-background-color: transparent; -fx-text-fill: #3182CE;" +
                "-fx-font-weight: 600; -fx-cursor: hand; -fx-font-size: 14px;");
        backBtn.setOnAction(e -> organizerDashboard.showMainContent());
        ...
        avatarCircle.setFill(Color.web("#3182CE"));
        ...
        changeAvatarBtn.setStyle("-fx-background-color: transparent; -fx-text-fill: #3182CE;" +
        ...
        roleLabel.setStyle("-fx-background-color: #3182CE; -fx-background-radius: 16;");
        ...
        cancelBtn.setStyle("-fx-background-color: transparent; -fx-text-fill: #1F2937;" +
                ...
                "-fx-border-color: #E5E7EB; -fx-border-radius: 6; -fx-font-size: 13px;");
        cancelBtn.setOnAction(e -> organizerDashboard.showMainContent());

        Button saveBtn = new Button("💾 Enregistrer");
        saveBtn.setStyle("-fx-background-color: #3182CE; -fx-text-fill: white; " +
        ...
        saveBtn.setOnAction(e -> {
            if (saveProfileChanges(nomField, prenomField, emailField, genreCombo,
                ...
                organizerDashboard.updateUserInfo(currentUser);
                organizerDashboard.showMainContent();
            }
        });
